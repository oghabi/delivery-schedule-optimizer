...
SUITE(M1_Public_Functionality_Tests) {
    ...
    TEST_FIXTURE(Map_Fixture, intersection_ID_street_names_functionality) {
        ...
        expected_result = {"Eglinton Avenue East", "Eglinton Avenue West", "Yonge Street"};
        result = find_intersection_street_names( find_intersection_id_from_name("Yonge Street & Eglinton Avenue East & Eglinton Avenue West") );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
    
        expected_result = {"Bay Street", "Dundas Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Bay Street & Dundas Street West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bay Street", "Wellington Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Bay Street & Wellington Street West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Dundas Street East", "Dundas Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Dundas Street West & Dundas Street East")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Carlton Street", "College Street", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & College Street & Carlton Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Queen Street East", "Queen Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Queen Street West & Queen Street East")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Adelaide Street West", "Bay Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Bay Street & Adelaide Street West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"King Street East", "King Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & King Street West & King Street East")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bloor Street East", "Bloor Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Bloor Street East & Bloor Street West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bay Street", "Bloor Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Bloor Street West & Bay Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Saint Clair Avenue East", "Saint Clair Avenue West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Saint Clair Avenue East & Saint Clair Avenue West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Front Street West", "University Avenue", "York Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("University Avenue & Front Street West & York Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Adelaide Street East", "Adelaide Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Adelaide Street West & Adelaide Street East")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Gerrard Street East", "Gerrard Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Gerrard Street West & Gerrard Street East")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bloor Street East", "Church Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Bloor Street East & Church Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bay Street", "King Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("King Street West & Bay Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Dundas Street West", "University Avenue"};
        result = find_intersection_street_names(  find_intersection_id_from_name("University Avenue & Dundas Street West") );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Harbord Street", "Hoskin Avenue", "St. George Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("St. George Street & Harbord Street & Hoskin Avenue")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bay Street", "College Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("College Street & Bay Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"John Street", "Queen Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Queen Street West & John Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Wellesley Street East", "Wellesley Street West", "Yonge Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Yonge Street & Wellesley Street East & Wellesley Street West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Bay Street", "Queen Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Queen Street West & Bay Street")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Avenue Road", "Bloor Street West", "Queen's Park"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Avenue Road & Bloor Street West & Queen's Park")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"Convention centre loading dock", "Front Street West", "John Street"};
        result = find_intersection_street_names(  find_intersection_id_from_name("Front Street West & John Street & Convention centre loading dock")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
        
        expected_result = {"University Avenue", "Wellington Street West"};
        result = find_intersection_street_names(  find_intersection_id_from_name("University Avenue & Wellington Street West")  );
        std::sort(result.begin(), result.end());
        CHECK_EQUAL(expected_result, result);
