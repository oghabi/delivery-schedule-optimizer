...
//This global variable tells us which arrow key on the keyboard was pressed
int Arrow_Key_Pressed;
 ...
 */
#define FONT_CACHE_SIZE_FOR_ZEROS 5000
#define FONT_CACHE_SIZE_FOR_ROTATED 5000
...
static const vector<t_color> predef_colors = {
    ...
    //My own colours for ECE297
    t_color(172, 207, 255), // "Google_Blue"
    t_color(0xCF, 0xCD, 0xCC), // "Google_Background"
    t_color(174, 189, 149), // "Google_Green"
    t_color(0, 179, 253) // "Google_Path_Blue"
};
...
//                printf("x: %d    y: %d\n", report.xmotion.x, report.xmotion.y);
            ...
            case KeyPress:
                ...
                if (gl_state.get_keypress_input) {
                    ...
                    if (keysym == XK_Left)  Arrow_Key_Pressed = LEFT_ARROW;
                        //cout << "Left arrow\n";
                    else if (keysym == XK_Right)  Arrow_Key_Pressed = RIGHT_ARROW;
                        //cout << "Right arrow\n";
                    else if (keysym == XK_Up)  Arrow_Key_Pressed = UP_ARROW;
                        //cout << "Up arrow\n";
                    else if (keysym == XK_Down)  Arrow_Key_Pressed = DOWN_ARROW;
                        //cout << "Down arrow\n";
                    // End new code.
